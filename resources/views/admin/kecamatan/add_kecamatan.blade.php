                    ...
                    <div class="card-body">
                        <form action="{{ route('kecamatan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col">
                                    <select name="kabupaten_id" class="form-select form-select mb-3 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="mb-3 mt-3 form-control @error('kecamatan') is-invalid @enderror" name="kecamatan" value="" placeholder="Masukkan Nama Kecamatan">
