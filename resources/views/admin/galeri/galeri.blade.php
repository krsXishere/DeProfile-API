                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                      <form action="{{route('galeri.search')}}" method="GET">
                        ...
                        <a href="{{route('galeri.create')}}" class="btn btn-md btn-success mb-3 btn-sm">Tambah galeri</a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin?');" action="{{ route('galeri.destroy', $row->id) }}" method="POST">
                                            <a href="{{ route('galeri.edit', $row->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                            @csrf
                                            @method('DELETE')
