        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{route('siswa.search', $id_sekolah)}}" method="GET">
                          @csrf
                          @method('GET')
                            <div class="row">
                              <div class="col">
                        ...
                        <div>
                          ...
                          <div>
                            <a href="{{route('siswa.create', $id_sekolah)}}" class="btn btn-md btn-success mb-3 btn-sm">Tambah Siswa</a>
                            <a href="{{route('siswa.create.bulk', $id_sekolah)}}" class="btn btn-md btn-success mb-3 btn-sm">Import dari Excel</a>
                          </div>
                        </div>
                              ...
                              @forelse ($siswa as $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin?');" action="{{ route('siswa.destroy', ['id' => $row->id, 'id_sekolah' => $id_sekolah]) }}" method="POST">
                                            <a href="{{ route('siswa.edit', ['id' => $row->id, 'id_sekolah' => $id_sekolah]) }}" class="btn btn-sm btn-primary">Edit</a>
                                            @csrf
                                            @method('DELETE')
