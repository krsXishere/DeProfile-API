        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{route('admin_sekolah_guru.search', $id_sekolah)}}" method="GET">
                          @csrf
                          @method('GET')
                            <div class="row">
                              <div class="col">
                        ...
                        <div>
                          ...
                          <div>
                            <a href="{{route('admin_sekolah_guru.create', $id_sekolah)}}" class="btn btn-md btn-success mb-3 btn-sm">Tambah Guru</a>
                            <a href="{{route('admin_sekolah_guru.create.bulk', $id_sekolah)}}" class="btn btn-md btn-success mb-3 btn-sm">Import dari Excel</a>
                          </div>
                        </div>
                              ...
                              @forelse ($guru as $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin?');" action="{{ route('admin_sekolah_guru.destroy', ['id' => $row->id, 'id_sekolah' => $id_sekolah]) }}" method="POST">
                                            <a href="{{ route('admin_sekolah_guru.edit', ['id' => $row->id, 'id_sekolah' => $id_sekolah]) }}" class="btn btn-sm btn-primary">Edit</a>
                                            @csrf
                                            @method('DELETE')
