        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                      <form action="{{route('admin_sekolah_ekstrakulikuler.search')}}" method="GET">
                        @csrf
                        @method('GET')
                          <div class="row">
                            <div class="col">
                        ...
                        <a href="{{route('admin_sekolah_ekstrakulikuler.create')}}" class="btn btn-md btn-success mb-3 btn-sm">Tambah Ekstrakulikuler</a>
                              ...
                              @forelse ($ekstrakulikuler as $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin?');" action="{{ route('admin_sekolah_ekstrakulikuler.destroy', $row->id) }}" method="POST">
                                            <a href="{{ route('admin_sekolah_ekstrakulikuler.edit', $row->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                            @csrf
                                            @method('DELETE')
