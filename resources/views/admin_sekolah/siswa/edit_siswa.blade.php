            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <form onsubmit="return confirm('Apakah Anda Yakin?');" action="{{ route('admin_sekolah_siswa.update', ['id' => $row->id, 'id_sekolah' => $id_sekolah]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
